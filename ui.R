...
shinyUI(fluidPage(
  ...
  p("If you are thinking of quitting research then why not make this vital decision based on evidence?
    This page contains a Bayesian calculator that combines a prior probability of ability with your number of failed fellowship applications.
...
More prior successes give a narrower prior around the mean. A prior success number of zero gives a flat uniform prior.
Lastly input your total number of failed fellowship applications (no successes allowed).
If your probability of being below average is greater than 0.90, then perhaps you should quit.
    For further details see this",
    tags$a(href="http://www.aushsi.org.au/when-should-i-quit-research-an-evidence-based-approach/", "blog post"), '.'),
  ...
  sidebarLayout(
    ...
    mainPanel(h3('Probability of being below average'),
              ...
              plotOutput(outputId = "main_plot", width = "70%")
    ) # end of main panel
  )
))
